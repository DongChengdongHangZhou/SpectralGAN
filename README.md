# SpectralGAN in PyTorch

**Note**:  The backbone of the proposed SpectralGAN is from [cyclegan](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix).

We provide PyTorch implementations for SpectralGAN which aims to mitigate the artifacts in GAN-generated images.
...
You may find useful information in [training/test tips](docs/tips.md) and [frequently asked questions](docs/qa.md). To implement custom models and datasets, check out our [templates](#custom-model-and-dataset). To help users better understand and adapt our codebase, we provide an [overview](docs/overview.md) of the code structure of this reposit
...
## Acknowledgments
The backbone of the proposed SpectralGAN is from [cyclegan](https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix).
